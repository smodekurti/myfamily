    ...
    final questions = [
      {
        ...
        'answer': 'Go to the Tasks tab and tap the "+" button. Fill in the task details, assign it to a family member, and set a due date if needed.',
      },
      {
        'question': 'How do I create a shopping list?',
        'answer': 'Go to the Shopping tab and tap the "+" button. You can create a new list or import items from a template. You can also create a shopping list when creating a grocery task.',
      },
      {
        'question': 'How do points work?',
        'answer': 'Points are automatically awarded when you complete tasks. The points are tracked per family member and displayed on the leaderboard. Complete more tasks to earn more points!',
      },
      {
        'question': 'Can I edit a completed task?',
        'answer': 'No, completed tasks cannot be edited. If you need to make changes, unmark the task as complete first, then you can edit it.',
      },
      {
        'question': 'How do I join a family?',
        'answer': 'Ask a family member for the family code. Then go to Profile > Join Family and enter the code. You\'ll be added to the family once the code is verified.',
      },
    ];
