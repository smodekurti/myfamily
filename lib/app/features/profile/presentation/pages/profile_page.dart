                                      ...
                                      if (currentFamily.inviteCode != null) ...[
                                          ...
                                          onTap: () async {
                                            ...
                                            if (context.mounted) {
                                              ScaffoldMessenger.of(
                                                ...
                                                SnackBar(
                                                  content: Text(
                                                    'Adult invite code copied to clipboard',
                                                  ),
                                                  duration: Duration(
                                                    seconds: 2,
                                                  ),
                                        ...
                                        Consumer(
                                          builder: (context, ref, child) {
                                            final generateCodeAsync = ref.watch(
                                              generateInviteCodeProvider(
                                                currentFamily.id,
                                              ),
                                            );
                                    ...
                                    children: [
                                      ...
                                      if (currentFamily.childInviteCode !=
                                          ...
                                          onTap: () async {
                                            ...
                                            if (context.mounted) {
                                              ScaffoldMessenger.of(
                                                ...
                                                SnackBar(
                                                  content: Text(
                                                    'Child invite code copied to clipboard',
                                                  ),
                                                  duration: Duration(
                                                    seconds: 2,
                                                  ),
                                        ...
                                        Consumer(
                                          builder: (context, ref, child) {
                                            final generateCodeAsync = ref.watch(
                                              generateChildInviteCodeProvider(
                                                currentFamily.id,
                                              ),
                                            );
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildProfileOption(
                                ...
                                onTap: () {
                                  context.push(
                                    AppConstants.routeFamilySettings,
                                  );
                                },
                              ),
